...
@Composable
fun MensScreen(navController: NavHostController) {
...
////    colorFilter = ColorFilter.tint(Color.Red),
    ...
    Column(
        ...
        Text(text = "Join CFF Men's Fellowship Program " , fontWeight = FontWeight.Bold, fontFamily = FontFamily.Cursive, fontSize = (20.sp) )
        ...
        Button(
            onClick = {  navController.navigate(ROUTE_PLEASE) {
