package net.ezra.ui.partnership
...
@Composable
fun PartnershipScreen(navController: NavHostController) {
...
////    colorFilter = ColorFilter.tint(Color.Red),
    ...
    Column(
        ...
        Text(text = "Become  A CFF  Church Partner" , fontWeight = FontWeight.Bold, fontFamily = FontFamily.Cursive, fontSize = (20.sp) )
...
fun HomeScreenPreviewLight() {
    PartnershipScreen(rememberNavController())
}
